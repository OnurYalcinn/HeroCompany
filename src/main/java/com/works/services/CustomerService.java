...
public class CustomerService {
    ...
    public ResponseEntity forgotPassword(String email) {
        ...
        if (optionalCustomer.isPresent()) {
            ...
            try {
                sendMessage("onuryalcin.96@gmail.com", "Password Reset Link", resetPasswordLink);
                hm.put(REnum.status,true);
    ...
    public void sendMessage(String to, String subject, String text) {
        ...
        message.setFrom("onuryalcin.96@gmail.com");
        message.setTo(to);
    ...
    public ResponseEntity resetPassword(String verificationCode,  String password) {
        Map<REnum, Object> hm = new LinkedHashMap();
        Optional<Customer> optionalCustomer = cusRepo.findByVerificationCodeEquals(verificationCode);
        if (optionalCustomer.isPresent()) {
            Customer customer = optionalCustomer.get();
